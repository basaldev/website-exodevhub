...
const MenuItem = styled(Link)`
  ${button}
  ${props => {
    return props.isActive ? `color:${designSystem.color('blue')}` : ''
  }};
      ...
      <LogoLink to="/">
        ...
        >
          ...
          <path
            ...
            stroke="#000"
            strokeWidth="5"
            d="M7.478 8.5H53.5v48H7.478v-48z"
          />
          <path
            className="frame"
            fill="#000"
            d="M0 0h49.84c.653 0 1.182.53 1.182 1.183v1.53c0 27.544-22.33 49.874-49.874 49.874A1.148 1.148 0 0 1 0 51.44V0z"
          />
        </svg>
      </LogoLink>
